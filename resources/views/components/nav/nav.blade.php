    ...
    <nav
        ...
        @if(!auth()->user())
            <div class="flex items-center gap-x-2 ms-auto py-1 md:ps-6 md:order-3 md:col-span-3">
                ...
                <div class="md:hidden">
                    <button type="button"
                            class="hs-collapse-toggle size-[38px] flex justify-center items-center text-sm font-semibold rounded-xl border border-gray-200 text-black hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-800 dark:border-neutral-700 dark:hover:bg-neutral-700"
        ...
        @else
            <div class="flex items-center gap-x-2 ms-auto py-1 md:ps-6 md:order-3 md:col-span-3">
                @if(auth()->user()->role->name === \App\Models\Role::USER)
    ...
    <!-- End Button Group -->
        ...
        <div id="navbar-collapse-with-animation"
            ...
            <div
                ...
                <div>
                    <a class="relative inline-block text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 dark:text-neutral-800"
                       href="{{ route('home.index') }}" aria-current="page">Accueil</a>
                </div>
                <div>
                    <a class="inline-block text-black hover:text-gray-600 dark:text-neutral-800 dark:hover:text-neutral-600"
                       href="{{ route('rooms.index') }}">Chambres</a>
                </div>
                <div>
                    <a class="inline-block text-black hover:text-gray-600 dark:text-neutral-800 dark:hover:text-neutral-600"
                       href="{{ route('about.index') }}">A propos</a>
                </div>
                <div>
                    <a class="inline-block text-black hover:text-gray-600 dark:text-neutral-800 dark:hover:text-neutral-600"
                       href="{{ route('contact.index') }}">A Contact</a>
                </div>
                <div>
                    <a class="inline-block text-black hover:text-gray-600 dark:text-neutral-800 dark:hover:text-neutral-600"
