...
@section('content')
    <div class="m-4 sm:m-10"> <!-- Modifier la marge pour être plus adaptée sur mobile -->

        <h1 class="text-lg sm:text-2xl">Réservation</h1>
        <!-- Stepper -->
        <div data-hs-stepper="">
            <!-- Stepper Nav -->
            <ul class="relative flex flex-col sm:flex-row gap-y-2 sm:gap-x-2">
                <li class="flex items-center gap-x-2 shrink basis-0 flex-1 group" data-hs-stepper-nav-item='{"index": 1}'>
                <span class="min-w-7 min-h-7 inline-flex items-center text-xs sm:text-base align-middle">
                    ...
                    <span class="ms-2 text-sm sm:text-base font-medium text-gray-800 dark:text-neutral-200">Step 1</span>
                </span>
                    <div class="flex-1 h-px bg-gray-200 group-last:hidden hs-stepper-success:bg-blue-600 hs-stepper-completed:bg-teal-600 dark:bg-neutral-700 dark:hs-stepper-success:bg-blue-600 dark:hs-stepper-completed:bg-teal-600 mx-2 hidden sm:block"></div>
                    <div class="flex-1 h-px bg-gray-200 group-last:hidden hs-stepper-success:bg-blue-600 hs-stepper-completed:bg-teal-600 dark:bg-neutral-700 dark:hs-stepper-success:bg-blue-600 dark:hs-stepper-completed:bg-teal-600 mx-2 block sm:hidden w-1/4"></div> <!-- Lignes plus petites sur mobile -->
                </li>
                <li class="flex items-center gap-x-2 shrink basis-0 flex-1 group" data-hs-stepper-nav-item='{"index": 2}'>
                    <div class="flex-1 h-px bg-gray-200 group-first:hidden hs-stepper-success:bg-blue-600 hs-stepper-completed:bg-teal-600 dark:bg-neutral-700 dark:hs-stepper-success:bg-blue-600 dark:hs-stepper-completed:bg-teal-600 mx-2 hidden sm:block"></div>
                    <div class="flex-1 h-px bg-gray-200 group-first:hidden hs-stepper-success:bg-blue-600 hs-stepper-completed:bg-teal-600 dark:bg-neutral-700 dark:hs-stepper-success:bg-blue-600 dark:hs-stepper-completed:bg-teal-600 mx-2 block sm:hidden w-1/4"></div> <!-- Lignes plus petites sur mobile -->
                    <span class="min-w-7 min-h-7 inline-flex items-center text-xs sm:text-base align-middle">
                    <span class="size-7 flex justify-center items-center flex-shrink-0 bg-gray-100 font-medium text-gray-800 rounded-full group-focus:bg-gray-200 hs-stepper-active:bg-blue-600 hs-stepper-active:text-white hs-stepper-success:bg-blue-600 hs-stepper-success:text-white hs-stepper-completed:bg-teal-500 hs-stepper-completed:group-focus:bg-teal-600 dark:bg-neutral-700 dark:text-white dark:group-focus:bg-gray-600 dark:hs-stepper-active:bg-blue-500 dark:hs-stepper-success:bg-blue-500 dark:hs-stepper-completed:bg-teal-500 dark:hs-stepper-completed:group-focus:bg-teal-600">
                    ...
                    <span class="ms-2 text-sm sm:text-base font-medium text-gray-800 dark:text-neutral-200">Step 2</span>
                </span>
                </li>
            </ul>
            <!-- End Stepper Nav -->
